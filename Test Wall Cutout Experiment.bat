...
start "Doom Top Mode Experiment" /D "%ENGINE_DIR%" "%ENGINE%" -config "%CONFIG%" -iwad "%IWAD%" -file "%VOXELS%" "%MOD%" +r_ortho_cutaway 0.0 +r_ortho_wallcutout 104 +r_ortho_hidesky 1 +gl_no_skyclear 1 +crosshair 0 +map MAP01
exit /b 0
